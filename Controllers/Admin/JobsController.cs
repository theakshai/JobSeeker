...
namespace JobSeeker.Controllers.Admin
{
    public class JobsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Salary,Company,Area,Category")] Job job)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Salary,Company,Area,Category")] Job job)
        {
            if (id != job.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'JobContext.Job'  is null.");
            }
            var job = await _context.Job.FindAsync(id);
            if (job != null)
            {
